...
namespace DevelopmentTests
{
	...
	{
		/// <summary>
		/// Tests if empty dependees and dependents returns false
		/// </summary>
		...
		/// <summary>
		/// Tests whether the replacement method removes the dependents
		/// </summary>
		[TestMethod, Timeout(5000)]
		public void testreplaceDependeeRemovesDependents()
		{
			DependencyGraph t = new DependencyGraph();
			t.ReplaceDependees("a", new HashSet<string>() { "b", "c", "z" });
		...
		/// <summary>
		/// Tests whether the replacement method replaces dependees
		/// </summary>
		[TestMethod, Timeout(5000)]
		public void testreplaceDependentRemovesDependees()
		{
			DependencyGraph t = new DependencyGraph();
			t.ReplaceDependents("a", new HashSet<string>() { "b", "c", "z" });
			Assert.AreEqual(3, t.Size);
		...
		/// <summary>
		/// Tests whether replacement fills in dempty dependents
		/// </summary>
		[TestMethod, Timeout(5000)]
		public void replaceEmptyDependents()
		{
			...
			t.ReplaceDependents("d", new HashSet<string>() { "b" });
			Assert.AreEqual(1, t.Size);
			t.ReplaceDependents("d", new HashSet<string>() { "b", "c", "z" });
			Assert.AreEqual(3, t.Size);
			t.ReplaceDependents("x", new HashSet<string>() { "a", "y", "w" });
			Assert.AreEqual(6, t.Size);

		}
		/// <summary>
		/// tests whether replacement method replaces dependees
		/// </summary>
		[TestMethod, Timeout(5000)]
		public void replaceEmptyDependees()
		{
			...
			Assert.AreEqual(1, t.Size);
			t.ReplaceDependees("d", new HashSet<string>() { "b", "c", "z" });
			Assert.AreEqual(3, t.Size);
			t.ReplaceDependees("x", new HashSet<string>() { "a", "y", "w" });
			Assert.AreEqual(6, t.Size);

		}
		/// <summary>
		/// Tests whether a provided key has dependents
		/// </summary>
		[TestMethod, Timeout(5000)]
		...
		/// <summary>
		/// Tests whether a key has no dependents. If no dependents found
		/// Should return false
		/// </summary>
		[TestMethod, Timeout(5000)]
		...
		/// <summary>
		/// Tests whether dependees exist for a provided key
		/// </summary>
		[TestMethod, Timeout(5000)]
		...
		/// <summary>
		/// Tests whether a key has no dependees. If no dependees found
		/// Should return false
		/// </summary>
		[TestMethod, Timeout(5000)]
		...
		public void DependeeSize()
		{
			DependencyGraph t = new DependencyGraph();
			t.AddDependency("x", "y");
			Console.WriteLine("dependees " + t["y"]);
		...
		/// <summary>
		/// Tests for size using all possible size changing methods
		/// </summary>
		[TestMethod(), Timeout(5000)]
		public void ThoroughSizeTest()
		{
			DependencyGraph t = new DependencyGraph();
			t.AddDependency("a", "b");
			t.AddDependency("a", "c");
			...
			t.ReplaceDependees("b", new HashSet<string>() { "w", "f" });
			Assert.AreEqual(2, t.Size);
			t.ReplaceDependents("c", new HashSet<string>() { "x", "z" });
			Assert.AreEqual(4, t.Size);
		}
		[TestMethod, Timeout(5000)]
		...
		public void EnumeratorTest()
		{
			...
			Console.WriteLine(t.GetDependees("b").GetEnumerator());
			...
			Console.WriteLine(t.GetDependees("c").GetEnumerator());
			Assert.IsTrue(e.MoveNext());
		...
		public void StressTest()
		{
			...
			Console.WriteLine("Dent size " + dents.Length);
			Console.WriteLine("Dee size " + dees.Length);
